...
export function getCorsHeaders(req: Request, overrides: CorsHeaders = {}): CorsHeaders {
...
export function handleCorsPreflightRequest(req: Request, overrides: CorsHeaders = {}): Response | null {

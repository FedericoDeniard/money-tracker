        ...
        {[
          {
            ...
            next_estimated_date: new Date(Date.now() + 86400000 * 5)
              .toISOString()
              .substring(0, 10),
          ...
          },
          {
            ...
            frequency: "monthly",
            last_date: new Date().toISOString().substring(0, 10),
            next_estimated_date: new Date(Date.now() + 86400000 * 12)
              .toISOString()
              .substring(0, 10),
            category: "entertainment",
            confidence_score: 98,
          ...
          },
          {
            ...
            frequency: "monthly",
            last_date: new Date().toISOString().substring(0, 10),
            next_estimated_date: new Date(Date.now() - 86400000 * 2)
              .toISOString()
              .substring(0, 10),
            category: "services",
            confidence_score: 85,
    ...
    >
      ...
      <div className="flex flex-col gap-3">
        {[
          ...
          <div
            key={i}
            className="relative p-4 rounded-2xl transition-all shadow-sm bg-white border border-[var(--text-secondary)]/10 hover:bg-gray-50"
          >

...
import { Mail, Lock, Loader2, AlertCircle, CheckCircle2, Banknote, Eye, EyeOff } from 'lucide-react';
        ...
        <div className="mb-6">
          ...
          <div className="mt-6">
            <button
              ...
              disabled={loading}
              className="w-full flex justify-center items-center gap-3 py-3 px-4 rounded-lg bg-[var(--bg-primary)] border border-[var(--text-secondary)]/30 text-sm font-semibold text-[var(--text-primary)] hover:bg-[var(--bg-secondary)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--text-secondary)] disabled:opacity-50 transition-all shadow-sm"
            >
        ...
        <form className="space-y-4" onSubmit={handleSubmit(handleEmailAuth)}>
          ...
          <div>
            <button
              ...
              className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-bold text-white bg-[var(--button-primary)] hover:bg-[var(--button-primary-hover)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--primary-focus)] disabled:opacity-50 disabled:cursor-not-allowed uppercase tracking-wide transition-colors"
            >

  ...
  payments: {
    Tables: {
      ...
      usage_limits_plan: {
        ...
        Relationships: [
          {
            foreignKeyName: "usage_limits_plan_plan_key_fkey"
            columns: ["plan_key"]
            isOneToOne: false
            referencedRelation: "plans"
    ...
    Views: {
      usage_limits_v: {
        Row: {
          ...
          period: Database["payments"]["Enums"]["usage_period"] | null
          scope_kind: Database["payments"]["Enums"]["usage_scope_kind"] | null
    ...
    Functions: {
      ...
      admin_usage_top_consumers: {
        Args: {
          p_capability: Database["payments"]["Enums"]["capability"]
          p_limit?: number
      ...
      check_and_increment_usage: {
        Args: { cap: string; period_kind?: string; target_user_id: string }
        Returns: {
          allowed: boolean
          limit_value: number
          remaining: number
      ...
      user_capabilities: {
        ...
        Returns: Database["payments"]["Enums"]["capability"][]
      }
    }
    Enums: {
      capability:
      ...
      usage_period: "month" | "day" | "hour"
      usage_scope_kind: "role" | "plan" | "default" | "team" | "org"
    }
    CompositeTypes: {
      [_ in never]: never
    }
